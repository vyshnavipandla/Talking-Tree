"""This is the final output of rasppi.
import "speech recognition","mmap","time","webbrowser","sqlite3","RPI.GPIO","os".
From the python files import openai,weather,currency,time,pollymmap.
while listening the speech the led will blink for that setup the led mode and pin number.
we define one function "listen_for_speech" .In this function microphone recognises the speech and converts into text.
Try block is used to check the text related to the database ,chrome,youtube,weather,currency,time and openai based on the "keywords" we given.
And returns the data if any error occur this will be handled by exception.😊
"""
